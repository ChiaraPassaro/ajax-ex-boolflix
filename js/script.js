...
// oggetto select la chiamata onload non funziona sempre correttamente
// var selectObject = {
//     //funzione per passare html
//     setTemplate(wrapper, sourceTemplate){
//         var thisObject = this;
...
//                     //image.src = 'img/' + result[i].iso_639_1 + '.png';
//
//                     //contattore per oggetto image
//                     var j = 0;
//                     image.onload = function() {
...
//                       //var thisUrlFlag = 'img/' + result[j].iso_639_1 + '.png';
//                       var thisLanguage = {
